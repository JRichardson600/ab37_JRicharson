...
public class TC11OrderReview {

	public static void main(String[] args) throws EncryptedDocumentException, IOException, InterruptedException {
		// TODO Auto-generated method stub
		FileInputStream f1 = new FileInputStream(
				"C:\\Users\\Richard\\eclipse-workspace\\Selenium\\ExcelSheet\\FB112110.xlsx");// location of
...
//		String fname = wb.getSheet("login").getRow(1).getCell(0).getStringCellValue();
		...
		String name = wb.getSheet("login").getRow(1).getCell(3).getStringCellValue();

		String cvv = NumberToTextConverter.toText(wb.getSheet("login").getRow(1).getCell(4).getNumericCellValue());
...
//		results.get(count_am_sug - 20).click();
		...
		Card_no.clear();
		Card_no.sendKeys("5446700108588902");

		WebElement nickName_no = driver.findElement(By.xpath(
				"(//input[@class='a-input-text a-form-normal apx-add-credit-card-account-holder-name-input mcx-input-fields'])"));
		nickName_no.clear();
		nickName_no.sendKeys(name);

		WebElement month_dd = driver.findElement(By.xpath(
				"(// span[@class='a-button-inner']// span[@class='a-button-text a-declarative']// span[@class='a-dropdown-prompt'])[1]"));
		month_dd.click();

//		Select s1 = new Select(month_dd);
//		s1.selectByVisibleText("12");

		WebElement monthVal_dd = driver.findElement(By.linkText("12"));
		monthVal_dd.click();

//		WebElement year_dd = driver.findElement(By.xpath(
//				"(// span[@class='a-button a-button-dropdown pmts-expiry-year pmts-portal-component pmts-portal-components-pp-CFDyQI-3']// span[@class='a-button-inner']// span[@class='a-button-text a-declarative']// span[@class='a-dropdown-prompt'])[1]"));
//		year_dd.click();

		WebElement year_dd = driver.findElement(By.xpath("((// span[@class='a-dropdown-container'])[2])"));
		year_dd.click();

		WebElement year2026_dd = driver.findElement(By.linkText("2026"));
		year2026_dd.click();

		WebElement cont_btn = driver
				.findElement(By.xpath("// span[@class='a-button a-button-primary pmts-button-input']"));
		cont_btn.click();

		// driver.switchTo().frame(First_frame);

		WebElement cvv_tf = driver.findElement(By.xpath("// input[@class='a-input-text a-form-normal a-width-small']"));
		cvv_tf.sendKeys(cvv);

		WebElement svcd_cb = driver.findElement(By.xpath("// div[@class='a-checkbox']"));
		svcd_cb.click();

		// driver.switchTo().alert().dismiss();

		WebElement close_btn = driver.findElement(By.xpath("(//button[@class=' a-button-close a-declarative'])"));
		close_btn.click();

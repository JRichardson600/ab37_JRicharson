/* 7.Ensure that teh products deatil page displays all necessary information (price, reviews , description) */
...
public class TC7FiltersRelevance {
...
//		String fname = wb.getSheet("login").getRow(1).getCell(0).getStringCellValue();
		...
		// WebElement cate_dd = driver.findElement(By.id("searchDropdownBox"));// locate
